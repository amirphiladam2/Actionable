...
const AuthScreen = () => {
  ...
  const validateForm = useCallback(() => {
    ...
    // Fix: Extract errors from validation result
    const newErrors = validationResult.errors || {};
    setErrors(newErrors);
    
    // Return the isValid property
  ...
  const handleDeepLink = (url) => {
    ...
    if (url?.includes('actionable://') && url?.includes('auth')) {
      console.log('Auth deep link detected, navigating to home...');
      ...
      >
        ...
        >
          ...
          >
            ...
            <Animated.View style={[AuthStyles.formContainer, { opacity: fadeAnimation }]}>
              {activeTab === "signin" ? (
                ...
                <View>
                  {/* Name Input - Fix: Use consistent field name */}
                  <View style={AuthStyles.inputGroup}>
                  ...
                  {/* Email Input - Fix: Use 'email' field name consistently */}
                  <View style={AuthStyles.inputGroup}>
                    <Text style={AuthStyles.inputLabel}>Email</Text>
                    <View style={[AuthStyles.inputWrapper, errors.email && AuthStyles.inputWrapperError]}>
                      <Ionicons name="mail" size={20} color="#9CA3AF" style={AuthStyles.inputIcon} />
                  ...
                  {/* Password Input - Fix: Use 'password' field name consistently */}
                  <View style={AuthStyles.inputGroup}>
                    <Text style={AuthStyles.inputLabel}>Password</Text>
                    <View style={[AuthStyles.inputWrapper, errors.password && AuthStyles.inputWrapperError]}>
                      <Ionicons name="lock-closed" size={20} color="#9CA3AF" style={AuthStyles.inputIcon} />
          ...
          <TouchableOpacity
            ...
            onPress={signin.handleGoogleSignIn}
            disabled={isLoading}
          >
            <Image
